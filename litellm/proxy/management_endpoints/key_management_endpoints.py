...
async def _apply_key_generation_ownership_defaults(
    *,
    ...
    from litellm_bitovi.proxy.key_hooks.ownership import apply_key_generation_ownership_defaults

    await apply_key_generation_ownership_defaults(
        data=data,
...
async def _common_key_generation_helper(
    ...
    from litellm_bitovi.proxy.config_teams import apply_team_member_budget_to_sa_key
